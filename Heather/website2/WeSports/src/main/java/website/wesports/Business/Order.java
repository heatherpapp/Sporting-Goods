...
public class Order {
    ...
    /************* Constructors *************/
    public Order(String custEmail, String productCode, int quantity, Timestamp orderDate, String orderStatus, Date fulfillmentDate, String distUsername) {
        this(null, custEmail, productCode, quantity, orderDate, orderStatus, fulfillmentDate, distUsername);
    }

    public Order(Long orderID, String custEmail, String productCode, int quantity, Timestamp orderDate, String orderStatus, Date fulfillmentDate, String distUsername) {
        OrderID = orderID;
        CustEmail = custEmail;
    ...
    public void insertNewOrder(Long orderID, String custEmail, String productCode, int quantity, Timestamp orderDate, String orderStatus, Date fulfillmentDate, String distUsername) {
        ...
        try {
            ...
            if (!orderExists(orderID, connection)) {
                ...
                System.out.println("***** ERROR! ***** Cannot Insert NEW Customer! *****\n***** Customer Email: " + custEmail + " already exists! *****");
