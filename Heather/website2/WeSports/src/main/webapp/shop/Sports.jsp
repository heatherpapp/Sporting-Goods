        ...
        <div class="container">
                ...
                <ul>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="${pageContext.request.contextPath}/sports/Basketball.jsp">Basketball</a>
            ...
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Baseball.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/baseball_and_bat.jpg" alt="baseball in a glove next to a bat on the ground">
                    <button>Baseball</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Basketball.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/basketball_in_net.jpg" alt="basketball in net">
                    <button>Basketball</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Football.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/football_and_helmet.jpg" alt="football next to helmet on the ground">
                    <button>Football</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Golf.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/golf_tee_club_hand.jpg" alt="hand placing golf ball on a tee with club">
                    <button>Golf</button>
                </a>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Soccer.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/soccerball_in_net_score.jpg" alt="soccer ball in net">
                    <button>Soccer</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Tennis.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/tennis_racquets_balls_net.jpg" alt="tennis rackets leaning against net with balls on the ground">
                    <button>Tennis</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/sports/Volleyball.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/volleyball_hands.jpg" alt="hands lobbing a volleyball">
