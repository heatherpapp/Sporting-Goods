...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card">
                <a href="../shop/sports/Baseball.jsp">
            ...
            <div class="card">
                <a href="../shop/sports/Basketball.jsp">
                    <img src="../resources/pictures/basketball_in_net.jpg" alt="basketball in net">
                    <button>Basketball</button>
                </a>
            </div>
            <div class="card">
                <a href="../shop/sports/Football.jsp">
                    <img src="../resources/pictures/football_and_helmet.jpg" alt="football next to helmet on the ground">
                    <button>Football</button>
                </a>
            </div>
            <div class="card">
                <a href="../shop/sports/Golf.jsp">
                    <img src="../resources/pictures/golf_tee_club_hand.jpg" alt="hand placing golf ball on a tee with club">
                    <button>Golf</button>
                </a>
            <div class="card">
                <a href="../shop/sports/Soccer.jsp">
                    <img src="../resources/pictures/soccerball_in_net_score.jpg" alt="soccer ball in net">
                    <button>Soccer</button>
                </a>
            </div>
            <div class="card">
                <a href="../shop/sports/Tennis.jsp">
                    <img src="../resources/pictures/tennis_racquets_balls_net.jpg" alt="tennis rackets leaning against net with balls on the ground">
                    <button>Tennis</button>
                </a>
            </div>
            <div class="card">
                <a href="../shop/sports/Volleyball.jsp">
                    <img src="../resources/pictures/volleyball_hands.jpg" alt="hands lobbing a volleyball">
