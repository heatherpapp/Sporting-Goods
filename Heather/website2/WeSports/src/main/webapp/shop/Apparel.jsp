...
<html>
    <head>
        ...
        <title>WeSports | Shop Apparel</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/apparel/Women.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/woman.jpg" alt="Image 1">
                    <button>Shop Women's Apparel</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/apparel/Junior.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/TeensPlayingSports.jpg" alt="Image 1">
                    <button>Shop Junior Apparel</button>
                </a>
            </div>
            <div class="card">
                <a href="${pageContext.request.contextPath}/shop/apparel/Youth.jsp">
                    <img src="${pageContext.request.contextPath}/resources/pictures/Kids.jpeg" alt="Image 1">
