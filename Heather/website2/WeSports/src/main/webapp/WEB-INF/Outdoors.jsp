...
<html>
    <head>
        ...
        <title>We Sports | Shop Outdoors</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="card">
                <a href="Baseball.jsp">
                    <img src="/Website/Pictures/camping.jpg" alt="tent on a lakeside">
                    <button>Camping</button>
                </a>
            </div>
            <div class="card">
                <a href="Basketball.jsp">
                    <img src="/Website/Pictures/outdoor.jpeg" alt="man climbing">
                    <button>Climbing</button>
                </a>
            </div>
            <div class="card">
                <a href="Football.jsp">
                    <img src="/Website/Pictures/fishing.jpg" alt="Man fishing">
                    <button>Fishing</button>
                </a>
            </div>
            <div class="card">
                <a href="Golf.jsp">
                    <img src="/Website/Pictures/kayakingSunset.jpg" alt="Image 1">
